package com.example.slides_app;
...
import com.example.slides.SlideLoader;
...
public class SlideListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(this, slideLoader.getSlidesList(), mTwoPane));
    }
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        SimpleItemRecyclerViewAdapter(SlideListActivity parent,
